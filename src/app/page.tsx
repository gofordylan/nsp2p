          ...
          {session?.user ? (
            ...
            <>
              <form action={signInAction} className="flex flex-1">
                ...
                <button
                  type="submit"
                  className="flex flex-1 h-[49px] items-center justify-center rounded-[10px] bg-[#1A1A1A] text-[15px] font-semibold text-white hover:bg-[#333333] transition-colors cursor-pointer"
                >
                  Browse Offers
                </button>
              </form>
              <form action={signInAction} className="flex flex-1">
                ...
                <button
                  type="submit"
                  className="flex flex-1 h-[49px] items-center justify-center rounded-[10px] border-[1.5px] border-[#D0CCC6] text-[15px] font-semibold text-[#1A1A1A] hover:bg-[#EEECEA] transition-colors cursor-pointer"
                >
                  Create Offer
                </button>
              </form>
